...
const { signToken } = require("../utils/generateRoken");
...
const resolvers = {
  ...
  Mutation: {
    addUser: async (parent, { firstName, lastName, email, password, instructorNumber }) => {
      const user = await User.create({ firstName, lastName, email, password, instructorNumber });
