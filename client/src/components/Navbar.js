...
const Navbar = ({ currentPage, handlePageChange }) => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      <h1 className='w-full text-3xl font-bold text-[#00df9a]'><a href="#About" onClick={() => handlePageChange("About")}
            className={
              currentPage === "About" ? "nav-link active" : "nav-link"
            }>J.I.M.</a></h1>
      <ul className='hidden md:flex'>
        <li className='p-4'><a href="#Calendar" onClick={() => handlePageChange("Calendar")}
            className={
              currentPage === "Calendar" ? "nav-link active" : "nav-link"
            }>Calendar</a></li>
        <li className='p-4'><a href="#Profile" onClick={() => handlePageChange("Profile")}
            className={
        ...
        <li className='p-4'><a href="#Contact" onClick={() => handlePageChange("Contact")}
            className={
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
        <h1 className='w-full text-3xl font-bold text-[#00df9a] m-4'>J.I.M</h1>
          <li className='p-4 border-b border-gray-600'><a href="#Calendar" onClick={() => handlePageChange("Calendar")}
            className={
              currentPage === "Calendar" ? "nav-link active" : "nav-link"
            }>Calendar</a></li>
          <li className='p-4 border-b border-gray-600'><a href="#Profile" onClick={() => handlePageChange("Profile")}
            className={
              currentPage === "Profile" ? "nav-link active" : "nav-link"
            }>Profile</a></li>
